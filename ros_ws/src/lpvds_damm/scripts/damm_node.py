...
sys.path.insert(
    0,
    '/workspace/ros_ws/src/lpvds_damm/src/util'
    # '/home/tianyu/ncds_ws/non-conservative-DS-controller/ros_ws/src/lpvds_damm/src/util/'
)
...
class DAMMLPVDSNode(object):
    ...
    def load_P_matrix(self):
        ...
        # p_file_path = rospy.get_param('~p_json_file', '/home/tianyu/ncds_ws/non-conservative-DS-controller/ros_ws/src/lpvds_damm/trained_ds/p.json')
